...
* [How to login to GovCMS](unit-1-intro-to-the-admin-backend/how-to-login.md)
  * [Exercise 1.1 - Login as Administrator](unit-1-intro-to-the-admin-backend/Exercise-1.1-Login-as-Administrator.md)
...
* [The Frontend Homepage Layout](unit-1-intro-to-the-admin-backend/the-frontend-homepage-layout.md)
  * [Exercise 1.2 - View the Site Frontend content](unit-1-intro-to-the-admin-backend/Exercise-1-2-View-the-Site-Frontend-content.md)
...
* [Content management - filters overview](unit-1-intro-to-the-admin-backend/content-management-filters-overview.md)
  * [Exercise 1.4 - Filtering Content](unit-1-intro-to-the-admin-backend/content-management-filters-overview/exercise-1-4-filtering-content.md)
...
* [Managing content revisions](unit-4-managing-content-revisions/managing-content-revisions.md)
  * [Exercise 4.1 - View revisions history](unit-4-managing-content-revisions/Exercise-4-1-View-Revisions-History.md)
  * [Exercise 4.2 - Revert a content revision](unit-4-managing-content-revisions/Exercise-4-2-Revert-a-content-revision.md)
...
* [Content moderation in GovCMS](unit-5-content-moderation-in-govcms/content-moderation-in-govcms.md)
  * [Exercise 5.1 - Content moderation](unit-5-content-moderation-in-govcms/Exercise-5-1-Content-Moderation.md)

## UNIT 6: Files and media assets <a href="#unit-6-files-media-assets" id="unit-6-files-media-assets"></a>
...
* [URL aliases and redirects](unit-7-managing-url-aliases-and-redirects/url-aliases-and-redirects.md)
  * [Exercise 7.1 - Update a page's URL alias](unit-7-managing-url-aliases-and-redirects/Exercise-7-1-update-page-url-alias.md)
  * [Exercise 7.2 - Create a URL alias](unit-7-managing-url-aliases-and-redirects/Exercise-7-2-create-a-url-alias.md)
  * [Exercise 7.3 - Create a Redirect (advanced)](unit-7-managing-url-aliases-and-redirects/advanced-exercise-7-3-create-a-redirect.md)

## UNIT 8: META TAGS AND SEO

* [Meta tags and SEO](unit-8-meta-tags-and-seo/meta-tags-and-seo.md)
* [Tokens and default meta tags](unit-8-meta-tags-and-seo/tokens-and-default-meta-tags.md)
  * [Exercise 8.1 - Update meta tags of content](unit-8-meta-tags-and-seo/exercise-8-1-update-meta-tags-of-content.md)
...
* [Capturing data with forms](unit-11-capturing-data-with-forms/capturing-data-with-forms.md)
  * [Exercise 11.1 - Create a basic Webform](unit-11-capturing-data-with-forms/exercise-11-1-create-a-basic-webform.md)
* [Webform components](unit-11-capturing-data-with-forms/webform-components.md)
  * [Exercise 11.2 - Attach a form to a Webform page](unit-11-capturing-data-with-forms/exercise-11-2-attach-a-form-to-a-webform-page.md)
  * [Exercise 11.3 - Create an event registration form](unit-11-capturing-data-with-forms/exercise-11-3-create-an-event-registration-form.md)
